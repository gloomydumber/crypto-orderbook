...
export function useOrderbook(rawExchangeData?: { rawResponses: Record<string, unknown> }) {
  ...
  // Fetch available pairs when exchange/quote changes (skip internal fetch if host provides raw data)
  useAvailablePairs(rawExchangeData)
